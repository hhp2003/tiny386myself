...
#define USE_LCD_EK79007 //启用 EK79007 LCD 驱动相关代码（在代码里用 #ifdef USE_LCD_EK79007 见 lcd_ek79007.c）
#define LCD_WIDTH 1024 //宽 1024
#define LCD_HEIGHT 600 //高 600

//定义 SDMMC/SDIO 信号对应的 GPIO 编号，用于初始化 SD 卡接口。
//SD卡接口在这里配置，sdkconfig里面没有SD卡接口配置，不用改
#define SD_CLK 43
#define SD_CMD 44
#define SD_D0 39
#define SD_D1 40
